...
public class LocalMultiPlayerGame extends AppCompatActivity implements View.OnClickListener {
    ...
    private List<String> randSequence = DataHolder.getInstance().getRandSequence();
    ...
    public void onClick(View v) {
        switch(v.getId()) {
            ...
            case R.id.play_again_button:
                Intent playIntent = new Intent(LocalMultiPlayerGame.this,
                        LocalCodeSelect.class);
                startActivity(playIntent);
                break;

            case R.id.quit_to_menu_button:
                Intent quitIntent = new Intent(LocalMultiPlayerGame.this,
            ...
            case R.id.restart_button:
                Intent restartIntent = new Intent(LocalMultiPlayerGame.this,
                        LocalCodeSelect.class);
                startActivity(restartIntent);
                break;

            case R.id.quit_game_button:
                Intent quitGameIntent = new Intent(LocalMultiPlayerGame.this,
                        SettingActivity.class);
                DataHolder.getInstance().setHeight(10);
                DataHolder.getInstance().setWidth(4);
                DataHolder.getInstance().setAllowDuplicates(false);
